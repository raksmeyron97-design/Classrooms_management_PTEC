...
const apps = [
    ...
    { name: 'វិភាគទិន្នន័យសរុប', icon: 'line-chart', url: 'score_analyse/data_analysing_score_student.html', color: 'from-rose-600 to-pink-700'},
    { name: 'វិភាគតាមមុខវិជ្ជា', icon: 'target', url: 'score_analyse/data_analyses_by_subject.html', color: 'from-blue-600 to-indigo-700' },
